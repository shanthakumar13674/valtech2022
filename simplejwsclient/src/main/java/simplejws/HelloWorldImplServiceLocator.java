...
public class HelloWorldImplServiceLocator extends org.apache.axis.client.Service implements simplejws.HelloWorldImplService {
    ...
    private java.lang.String HelloWorldImplPort_address = "http://localhost:8080/simplejws/services/HelloWorldImplPort";
    ...
    public simplejws.HelloWorld getHelloWorldImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public simplejws.HelloWorld getHelloWorldImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            simplejws.HelloWorldImplServiceSoapBindingStub _stub = new simplejws.HelloWorldImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (simplejws.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                simplejws.HelloWorldImplServiceSoapBindingStub _stub = new simplejws.HelloWorldImplServiceSoapBindingStub(new java.net.URL(HelloWorldImplPort_address), this);
                _stub.setPortName(getHelloWorldImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://simplejws/", "HelloWorldImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://simplejws/", "HelloWorldImplPort"));
        }
